...
LABEL com.jitesoft.project.repo.type="git" \
      ...
      com.jitesoft.app.clair-scanner.version="${SCANNER_VERSION}" \
...
RUN apk add --no-cache curl ca-certificates \
 && curl -LsS https://github.com/arminc/clair-scanner/releases/download/${SCANNER_VERSION}/clair-scanner_linux_amd64 -o /usr/local/bin/clair-scanner \
